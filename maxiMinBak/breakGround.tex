...
\item[Devyn] But here's the problem, see: If I drink too much, I
  ...
  have a love-hate relationship with coffee. Unless I drink just the right amount! Then it's a love relationship.
\item[Riley] If only there were a calculus solution to this problem!
\end{dialogue}

Remember, calculus is about studying functions. If we can ``see'' a function in the work above, maybe we can figure out how to solve Devyn's problem (of finding the right amount of coffee to drink). 
