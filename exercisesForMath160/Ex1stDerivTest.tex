...
%%PROBLEM 2
\begin{exercise}
The function $f(x) =\displaystyle\frac{1}{4\sqrt{x}}+x$.
...
%%PROBLEM 3-- this problem is screwy!!!!!! nasty hard derivative to set=0... and these are all wrong.  I don't nkow if we can fix by making it "given f', etc. because if f' dne, what do we know about the function???? What is the purpose of this?
\begin{exercise}
The function (read carefully!) $f'(x) =\frac{x^2-2x+1}{x(1+x^2)}$ has one critical
