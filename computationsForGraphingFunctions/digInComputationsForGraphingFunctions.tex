...
\item Find the places where the function could change direction (the points where $f'(x) = 0$ or
  $f'(x)$ is undefined). (If the point is in the domain of $f$ then these points are called critical points.)
...
\begin{explanation}
 ...
 Try this on your own first, then either check with a friend, a graphing calculator, or a website (like www.desmos.com).
